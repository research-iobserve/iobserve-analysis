...
public class RepositoryModelProviderTest implements IModelProviderTest { // NOCS no constructor in
    ...
    private static Graph graph = new GraphLoader(RepositoryModelProviderTest.GRAPH_DIR)
            .createModelGraph(RepositoryFactory.eINSTANCE);
    ...
    public void createThenCloneThenRead() {
        ...
        graph2 = modelProvider1.cloneNewGraphVersion(RepositoryFactory.eINSTANCE);
