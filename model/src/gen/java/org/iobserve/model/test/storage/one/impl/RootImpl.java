 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.RootImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.RootImpl#getLabels <em>Labels</em>}</li>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.RootImpl#getFixed <em>Fixed</em>}</li>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.RootImpl#getEnumerate <em>Enumerate</em>}</li>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.RootImpl#getOthers <em>Others</em>}</li>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.RootImpl#getIfaceOthers <em>Iface Others</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootImpl extends MinimalEObjectImpl.Container implements Root {
    ...
    protected EClass eStaticClass() {
        return OnePackage.Literals.ROOT;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OnePackage.ROOT__NAME, oldName, name));
    }
    ...
    public EList<String> getLabels() {
        if (labels == null) {
            labels = new EDataTypeUniqueEList<String>(String.class, this, OnePackage.ROOT__LABELS);
        }
        return labels;
    }
    ...
    public void setFixed(String newFixed) {
        ...
        fixed = newFixed;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OnePackage.ROOT__FIXED, oldFixed, fixed));
    }
    ...
    public void setEnumerate(EnumValueExample newEnumerate) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OnePackage.ROOT__ENUMERATE, oldEnumerate, enumerate));
    }
    ...
    public EList<Other> getOthers() {
        if (others == null) {
            others = new EObjectContainmentEList<Other>(Other.class, this, OnePackage.ROOT__OTHERS);
        }
        return others;
    }
    ...
    public EList<OtherInterface> getIfaceOthers() {
        if (ifaceOthers == null) {
            ifaceOthers = new EObjectContainmentEList<OtherInterface>(OtherInterface.class, this, OnePackage.ROOT__IFACE_OTHERS);
        }
        return ifaceOthers;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case OnePackage.ROOT__OTHERS:
                return ((InternalEList<?>)getOthers()).basicRemove(otherEnd, msgs);
            case OnePackage.ROOT__IFACE_OTHERS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case OnePackage.ROOT__NAME:
                return getName();
            case OnePackage.ROOT__LABELS:
                return getLabels();
            case OnePackage.ROOT__FIXED:
                return getFixed();
            case OnePackage.ROOT__ENUMERATE:
                return getEnumerate();
            case OnePackage.ROOT__OTHERS:
                return getOthers();
            case OnePackage.ROOT__IFACE_OTHERS:
