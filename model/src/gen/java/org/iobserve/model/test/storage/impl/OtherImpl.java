 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.model.test.storage.impl.OtherImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OtherImpl extends MinimalEObjectImpl.Container implements Other {
    ...
    protected EClass eStaticClass() {
        return StoragePackage.Literals.OTHER;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, StoragePackage.OTHER__NAME, oldName, name));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case StoragePackage.OTHER__NAME:
                return getName();
        }
