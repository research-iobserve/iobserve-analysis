...
import org.iobserve.model.test.storage.two.impl.TwoPackageImpl;
...
public class OnePackageImpl extends EPackageImpl implements OnePackage {
     ...
     * @see org.iobserve.model.test.storage.one.OnePackage#eNS_URI
     * @see #init()
     * @generated
     */
    ...
    public static OnePackage init() {
        if (isInited) return (OnePackage)EPackage.Registry.INSTANCE.getEPackage(OnePackage.eNS_URI);

        // Obtain or create and register package
        OnePackageImpl theOnePackage = (OnePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OnePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OnePackageImpl());

        isInited = true;

        // Obtain or create and register interdependencies
        TwoPackageImpl theTwoPackage = (TwoPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(TwoPackage.eNS_URI) instanceof TwoPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(TwoPackage.eNS_URI) : TwoPackage.eINSTANCE);
