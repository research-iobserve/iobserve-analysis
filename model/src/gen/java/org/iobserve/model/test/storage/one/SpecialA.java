 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.model.test.storage.one.SpecialA#getRelate <em>Relate</em>}</li>
 * </ul>
 *
 * @see org.iobserve.model.test.storage.one.OnePackage#getSpecialA()
 * @model
 * @generated
 */
public interface SpecialA extends OtherInterface {
     ...
     * @see #setRelate(Other)
     * @see org.iobserve.model.test.storage.one.OnePackage#getSpecialA_Relate()
     * @model
     * @generated
     */
    Other getRelate();
    ...
    /**
     * Sets the value of the '{@link org.iobserve.model.test.storage.one.SpecialA#getRelate <em>Relate</em>}' reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
