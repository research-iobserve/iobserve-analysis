...
import org.iobserve.model.test.storage.one.OtherSubType;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.OtherSubTypeImpl#isLabel <em>Label</em>}</li>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.OtherSubTypeImpl#getOther <em>Other</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OtherSubTypeImpl extends OtherImpl implements OtherSubType {
    ...
    protected EClass eStaticClass() {
        return OnePackage.Literals.OTHER_SUB_TYPE;
    }
    ...
    public void setLabel(boolean newLabel) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OnePackage.OTHER_SUB_TYPE__LABEL, oldLabel, label));
    }
    ...
    public void setOther(Other newOther) {
        if (newOther != other) {
            ...
            if (other != null)
                msgs = ((InternalEObject)other).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OnePackage.OTHER_SUB_TYPE__OTHER, null, msgs);
            if (newOther != null)
                msgs = ((InternalEObject)newOther).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OnePackage.OTHER_SUB_TYPE__OTHER, null, msgs);
            msgs = basicSetOther(newOther, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OnePackage.OTHER_SUB_TYPE__OTHER, newOther, newOther));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case OnePackage.OTHER_SUB_TYPE__OTHER:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case OnePackage.OTHER_SUB_TYPE__LABEL:
                return isLabel();
            case OnePackage.OTHER_SUB_TYPE__OTHER:
                return getOther();
        }
