 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.model.test.storage.one.impl.SpecialBImpl#getNext <em>Next</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecialBImpl extends MinimalEObjectImpl.Container implements SpecialB {
    ...
    protected EClass eStaticClass() {
        return OnePackage.Literals.SPECIAL_B;
    }
    ...
    public NotificationChain basicSetNext(OtherInterface newNext, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OnePackage.SPECIAL_B__NEXT, oldNext, newNext);
    ...
    public void setNext(OtherInterface newNext) {
        if (newNext != next) {
            ...
            if (next != null)
                msgs = ((InternalEObject)next).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OnePackage.SPECIAL_B__NEXT, null, msgs);
            if (newNext != null)
                msgs = ((InternalEObject)newNext).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OnePackage.SPECIAL_B__NEXT, null, msgs);
            msgs = basicSetNext(newNext, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, OnePackage.SPECIAL_B__NEXT, newNext, newNext));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case OnePackage.SPECIAL_B__NEXT:
