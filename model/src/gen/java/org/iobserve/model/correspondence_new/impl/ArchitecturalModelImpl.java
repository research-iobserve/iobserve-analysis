 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.model.correspondence_new.impl.ArchitecturalModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArchitecturalModelImpl extends MinimalEObjectImpl.Container implements ArchitecturalModel {
	...
	protected EClass eStaticClass() {
		return Correspondence_newPackage.Literals.ARCHITECTURAL_MODEL;
	}
	...
	public EList<ArchitecturalModelElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<ArchitecturalModelElement>(ArchitecturalModelElement.class, this, Correspondence_newPackage.ARCHITECTURAL_MODEL__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Correspondence_newPackage.ARCHITECTURAL_MODEL__ELEMENTS:
