 ...
 *
 */
public final class AllocationModelFactory {

    /**
     *
     * @param modelProvider
     */
    private AllocationModelFactory() {
    }
    ...
    public static boolean isAllocationPresent(final Allocation allocationModel,
            final ResourceContainer resourceContainer, final AssemblyContext assemblyContext) {
        return allocationModel.getAllocationContexts_Allocation().stream()
                .filter(context -> context.getAssemblyContext_AllocationContext().getEntityName()
                        .equals(assemblyContext.getEntityName())
