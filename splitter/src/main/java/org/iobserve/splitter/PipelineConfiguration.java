...
public class PipelineConfiguration extends Configuration {
     ...
     */
    public PipelineConfiguration(final File dataLocation, final File outputLocation, final String[] hostnames)
            throws IOException {

        PipelineConfiguration.LOGGER.debug("Read from {}", dataLocation);
