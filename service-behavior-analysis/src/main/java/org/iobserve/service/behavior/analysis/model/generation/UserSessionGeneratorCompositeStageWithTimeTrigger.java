...
public class UserSessionGeneratorCompositeStageWithTimeTrigger extends CompositeStage {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(UserSessionGeneratorCompositeStageWithTimeTrigger.class);

    private final TimeTriggerStage sessionCollectionTimer;
     ...
     */
    public UserSessionGeneratorCompositeStageWithTimeTrigger(final Configuration configuration)
            throws ConfigurationException {
        /**
        ...
        if (triggerInterval < 0) {
            UserSessionGeneratorCompositeStageWithTimeTrigger.LOGGER
        ...
        this.sessionCollectionTimer = new TimeTriggerStage(triggerInterval, singleEventMode);
    ...
    private <T> T createFromConfiguration(final Class<T> clazz, final Configuration configuration, final String key,
        ...
        if (className.isEmpty()) {
            UserSessionGeneratorCompositeStageWithTimeTrigger.LOGGER.error("Initialization incomplete: {}",
                    errorMessage);
