...
public class ExtendedAfterOperationEvent extends AfterOperationEvent {
    ...
    public static final int SIZE = AbstractMonitoringRecord.TYPE_SIZE_LONG // IEventRecord.timestamp
            ...
            + AbstractMonitoringRecord.TYPE_SIZE_STRING // ExtendedAfterOperationEvent.informations
    ;
     ...
     *            informations
     */
    public ExtendedAfterOperationEvent(final long timestamp, final long traceId, final int orderIndex,
    ...
    public ExtendedAfterOperationEvent(final Object[] values) { // NOPMD (direct store of values)
        super(values, ExtendedAfterOperationEvent.TYPES);
     ...
     */
    protected ExtendedAfterOperationEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                                // (values
                                                                                                // stored
                                                                                                // directly)
     ...
     */
    public ExtendedAfterOperationEvent(final ByteBuffer buffer, final IRegistry<String> stringRegistry)
            throws BufferUnderflowException {
    ...
    public Class<?>[] getValueTypes() {
        return ExtendedAfterOperationEvent.TYPES; // NOPMD
    }
