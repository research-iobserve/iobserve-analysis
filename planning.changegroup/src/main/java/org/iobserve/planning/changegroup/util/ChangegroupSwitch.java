 ...
 * @generated
 */
public class ChangegroupSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ChangegroupPackage.CHANGE_GROUP: {
				ChangeGroup changeGroup = (ChangeGroup)theEObject;
				T result = caseChangeGroup(changeGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChangegroupPackage.ACTION: {
				Action action = (Action)theEObject;
				T result = caseAction(action);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChangegroupPackage.REPLICATE_ACTION: {
			...
			case ChangegroupPackage.MIGRATE_ACTION: {
			...
			case ChangegroupPackage.CHANGE_GROUP_REPOSITORY: {
				ChangeGroupRepository changeGroupRepository = (ChangeGroupRepository)theEObject;
				T result = caseChangeGroupRepository(changeGroupRepository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ChangegroupPackage.ALLOCATE_ACTION: {
			...
			case ChangegroupPackage.CONFIGURE_ACTION: {
				ConfigureAction configureAction = (ConfigureAction)theEObject;
				T result = caseConfigureAction(configureAction);
				if (result == null) result = caseAction(configureAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Change Group Repository</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Change Group Repository</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChangeGroupRepository(ChangeGroupRepository object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Configure Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Configure Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseConfigureAction(ConfigureAction object) {
		return null;
	}
