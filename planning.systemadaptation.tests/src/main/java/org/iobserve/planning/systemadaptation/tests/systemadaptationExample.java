...
import org.iobserve.planning.systemadaptation.util.systemadaptationResourceFactoryImpl;

/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>systemadaptation</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class systemadaptationExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put
			(Resource.Factory.Registry.DEFAULT_EXTENSION, 
			 new systemadaptationResourceFactoryImpl());

		// Register the package to ensure it is available during loading.
		//
		resourceSet.getPackageRegistry().put
			(systemadaptationPackage.eNS_URI, 
			 systemadaptationPackage.eINSTANCE);
