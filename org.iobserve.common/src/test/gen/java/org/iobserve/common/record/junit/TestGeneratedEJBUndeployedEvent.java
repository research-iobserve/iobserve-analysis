...
public class TestGeneratedEJBUndeployedEvent extends AbstractGeneratedKiekerTest {
	...
	/**
	 * Tests {@link EJBUndeployedEvent#TestEJBUndeployedEvent(String, String, long, long, long, String, int, int)}.
	 */
	@Test
	public void testToArray() { // NOPMD (assert missing)
	for (int i=0;i<ARRAY_LENGTH;i++) {
			// initialize
			EJBUndeployedEvent record = new EJBUndeployedEvent(LONG_VALUES.get(i % LONG_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()), STRING_VALUES.get(i % STRING_VALUES.size()));
