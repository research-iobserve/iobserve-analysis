...
public class ServerGeoLocation extends AbstractEvent implements GeoLocation {
    ...
    /** property name array. */
    private static final String[] PROPERTY_NAMES = { "timestamp", "countryCode", "hostname", "address", };
     ...
     *            address
     */
    public ServerGeoLocation(final long timestamp, final short countryCode, final String hostname,
     ...
     */
    @Deprecated
    protected ServerGeoLocation(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                      // (values
                                                                                      // stored
                                                                                      // directly)
