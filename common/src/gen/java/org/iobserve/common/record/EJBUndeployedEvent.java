...
public class EJBUndeployedEvent extends EJBDeploymentEvent implements IUndeploymentRecord {
     ...
     *            deploymentId
     */
    public EJBUndeployedEvent(final long timestamp, final String serivce, final String context,
     ...
     */
    @Deprecated
    protected EJBUndeployedEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                       // (values
                                                                                       // stored
                                                                                       // directly)
