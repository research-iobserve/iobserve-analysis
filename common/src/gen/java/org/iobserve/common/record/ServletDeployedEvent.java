...
public class ServletDeployedEvent extends ServletDeploymentEvent implements IDeploymentRecord {
     ...
     *            deploymentId
     */
    public ServletDeployedEvent(final long timestamp, final String serivce, final String context,
     ...
     */
    @Deprecated
    protected ServletDeployedEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                         // (values
                                                                                         // stored
                                                                                         // directly)
