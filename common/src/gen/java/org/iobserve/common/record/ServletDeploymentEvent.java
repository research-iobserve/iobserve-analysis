...
public abstract class ServletDeploymentEvent extends AbstractEvent {
     ...
     *            deploymentId
     */
    public ServletDeploymentEvent(final long timestamp, final String serivce, final String context,
     ...
     */
    @Deprecated
    protected ServletDeploymentEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                           // (values
                                                                                           // stored
                                                                                           // directly)
