...
public class ServletUndeployedEvent extends ServletDeploymentEvent implements IUndeploymentRecord {
    ...
    /** property name array. */
    private static final String[] PROPERTY_NAMES = { "timestamp", "serivce", "context", "deploymentId", };
     ...
     *            deploymentId
     */
    public ServletUndeployedEvent(final long timestamp, final String serivce, final String context,
     ...
     */
    @Deprecated
    protected ServletUndeployedEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                           // (values
                                                                                           // stored
                                                                                           // directly)
    ...
    public Object[] toArray() {
        return new Object[] { this.getTimestamp(), this.getSerivce(), this.getContext(), this.getDeploymentId() };
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (this.getTimestamp() != castedRecord.getTimestamp())
            return false;
        if (!this.getSerivce().equals(castedRecord.getSerivce()))
            return false;
