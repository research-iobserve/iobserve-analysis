...
public class EJBDeployedEvent extends EJBDeploymentEvent implements IDeploymentRecord {
     ...
     *            deploymentId
     */
    public EJBDeployedEvent(final long timestamp, final String serivce, final String context,
     ...
     */
    @Deprecated
    protected EJBDeployedEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                     // (values
                                                                                     // stored
                                                                                     // directly)
