 ...
 * @since 0.0.2
 */
public class EntryLevelBeforeOperationObjectEvent extends BeforeOperationObjectEvent
    ...
    private static final String[] PROPERTY_NAMES = { "timestamp", "traceId", "orderIndex", "operationSignature",
            "classSignature", "objectId", "parameters", "values", "requestType", };
     ...
     *            requestType
     */
    public EntryLevelBeforeOperationObjectEvent(final long timestamp, final long traceId, final int orderIndex,
            final String operationSignature, final String classSignature, final int objectId, final String[] parameters,
     ...
     *
     * @deprecated since 1.13. Use {@link #EntryLevelBeforeOperationObjectEvent(IValueDeserializer)}
     *             instead.
     */
    @Deprecated
    public EntryLevelBeforeOperationObjectEvent(final Object[] values) { // NOPMD (direct store of
                                                                         // values)
        super(values, TYPES);
     ...
     */
    @Deprecated
    protected EntryLevelBeforeOperationObjectEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                                         // (values
                                                                                                         // stored
                                                                                                         // directly)
    ...
    public Object[] toArray() {
        return new Object[] { this.getTimestamp(), this.getTraceId(), this.getOrderIndex(),
                this.getOperationSignature(), this.getClassSignature(), this.getObjectId(), this.getParameters(),
