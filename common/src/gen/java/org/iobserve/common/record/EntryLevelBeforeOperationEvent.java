...
public class EntryLevelBeforeOperationEvent extends BeforeOperationEvent implements IPayloadCharacterization {
     ...
     *
     * @deprecated since 1.13. Use {@link #EntryLevelBeforeOperationEvent(IValueDeserializer)}
     *             instead.
     */
    @Deprecated
     ...
     */
    @Deprecated
    protected EntryLevelBeforeOperationEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                                   // (values
                                                                                                   // stored
                                                                                                   // directly)
     ...
     */
    public EntryLevelBeforeOperationEvent(final IValueDeserializer deserializer) {
        super(deserializer);
        // load array sizes
