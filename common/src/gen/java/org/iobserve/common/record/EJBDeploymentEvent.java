...
public abstract class EJBDeploymentEvent extends AbstractEvent {
     ...
     *            deploymentId
     */
    public EJBDeploymentEvent(final long timestamp, final String serivce, final String context,
     ...
     */
    @Deprecated
    protected EJBDeploymentEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                       // (values
                                                                                       // stored
                                                                                       // directly)
