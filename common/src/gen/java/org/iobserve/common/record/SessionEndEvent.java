...
public class SessionEndEvent extends AbstractEvent implements ISessionEvent {
    ...
    /** property name array. */
    private static final String[] PROPERTY_NAMES = { "timestamp", "hostname", "sessionId", };
     ...
     *            sessionId
     */
    public SessionEndEvent(final long timestamp, final String hostname, final String sessionId) {
        super(timestamp);
     ...
     */
    @Deprecated
    protected SessionEndEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD (values
                                                                                    // stored
                                                                                    // directly)
    ...
    public Object[] toArray() {
        return new Object[] { this.getTimestamp(), this.getHostname(), this.getSessionId() };
    }
