...
public class TestGeneratedContainerAllocationEvent extends AbstractGeneratedKiekerTest {
	...
	/**
	 * Tests {@link ContainerAllocationEvent#TestContainerAllocationEvent(string)}.
	 */
	@Test
	...
	public void testEquality() {
		int i = 0;
		ContainerAllocationEvent oneRecord = new ContainerAllocationEvent(STRING_VALUES.get(i % STRING_VALUES.size()));
		i = 0;
		ContainerAllocationEvent copiedRecord = new ContainerAllocationEvent(STRING_VALUES.get(i % STRING_VALUES.size()));
	...
	public void testUnequality() {
		...
		ContainerAllocationEvent oneRecord = new ContainerAllocationEvent(STRING_VALUES.get(i % STRING_VALUES.size()));
		i = 2;
		ContainerAllocationEvent anotherRecord = new ContainerAllocationEvent(STRING_VALUES.get(i % STRING_VALUES.size()));
