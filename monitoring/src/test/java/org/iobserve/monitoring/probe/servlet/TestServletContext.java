...
public class TestServletContext implements ServletContext {
    ...
    @Override
    public javax.servlet.ServletRegistration.Dynamic addServlet(final String servletName, final Servlet servlet) {
        return null;
    }

    @Override
    public javax.servlet.ServletRegistration.Dynamic addServlet(final String servletName,
