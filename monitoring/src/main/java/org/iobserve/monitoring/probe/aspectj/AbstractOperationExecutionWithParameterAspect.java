 ...
 ***************************************************************************/
package org.iobserve.monitoring.probe.aspectj;
...
/**
 * Based on Jan Waller's kieker.monitoring.probe.aspectj.flow.operationExecution.AbstractAspect
 * class.
 *
 * @author Reiner Jung
 *
...
public abstract class AbstractOperationExecutionWithParameterAspect extends AbstractAspectJProbe { // NOPMD
    ...
    /**
     * The pointcut for the monitored operations. Inheriting classes should extend the pointcut in
     * order to find the correct executions of the methods (e.g. all methods or only methods with
