			...
			if (commandLine.hasOption("h")) {
				...
				if (correspondenceMappingFile.exists()) {
					if (correspondenceMappingFile.canRead()) {
						...
						throw new DaemonInitException("CLI error: Access denied to the correspondence file " + correspondenceMappingFile.getPath());
					}
				} else {
					throw new DaemonInitException("CLI error: Correspondence file " + correspondenceMappingFile.getPath() + " does not exist.");
				}
