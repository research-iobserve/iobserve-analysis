...
public class TerminateActionScript extends AbstractActionScript {
    private static final Logger LOGGER = LoggerFactory.getLogger(TerminateActionScript.class);
    ...
    private String getScript(final String scriptName) {
        ...
        try {
            ...
            TerminateActionScript.LOGGER
                    .warn("Could not find script for node termination. No script will be executed.");
            return "";
        }
    }
