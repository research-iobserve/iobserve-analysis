...
public class ModelModification {
	...
	public static void createNewModel(final CommandLine commandLine) throws InitializationException, IOException {
		...
		ResourceEnvironmentModification resEnvMod = new ResourceEnvironmentModification(modelProviders.getResourceEnvironmentModelProvider().getModel());
		...
		AllocationModification allocMod = new AllocationModification(modelProviders.getAllocationModelProvider().getModel(), modelProviders.getSystemModelProvider().getModel(),
				modelProviders.getResourceEnvironmentModelProvider().getModel());
		...
		SystemModification sysMod = new SystemModification(modelProviders.getSystemModelProvider().getModel(), modelProviders.getRepositoryModelProvider().getModel());
		...
		allocMod = new AllocationModification(modelProviders.getAllocationModelProvider().getModel(), modelProviders.getSystemModelProvider().getModel(), modelProviders.getResourceEnvironmentModelProvider().getModel());
