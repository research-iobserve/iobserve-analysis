...
public class ModelModification {
	...
	public static void createNewModel(final CommandLine commandLine) throws InitializationException, IOException {
		...
		Allocation allocationModel = modelProviders.getAllocationModelProvider().getModel();
		ResourceEnvironment resourceEnvironmentModel = modelProviders.getResourceEnvironmentModelProvider().getModel();
		System systemModel = modelProviders.getSystemModelProvider().getModel();
		Repository repositoryModel = modelProviders.getRepositoryModelProvider().getModel();

		ResourceEnvironmentModification resEnvMod = new ResourceEnvironmentModification(resourceEnvironmentModel);
		...
		SystemModification sysMod = new SystemModification(systemModel, repositoryModel);
