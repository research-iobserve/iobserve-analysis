 ...
 * <i>Run-time Architecture Models for Dynamic Adaptation and Evolution of Cloud
 * Applications</i>.
 * 
...
public final class CorrespondeceModelFactory {
	 ...
	 *            the information how Protocom generated source code out of PCM
	 *            components.
	 * @param mapper
	 *            this mapper is used to decide whether or not a method is
	 *            correct based on the provided operationSignature. Protocom
	 *            produces wired method names, which can vary from a lot from
