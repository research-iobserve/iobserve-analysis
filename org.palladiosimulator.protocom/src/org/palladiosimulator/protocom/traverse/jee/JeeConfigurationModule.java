...
public class JeeConfigurationModule extends CommonConfigurationModule {
    ...
    protected void configure() {
        super.configure();
        this.bind(XBasicComponent.class).to(JeeBasicComponent.class);
        this.bind(XSystem.class).to(JeeSystem.class);
        this.bind(XAllocation.class).to(JeeAllocation.class);
    }
