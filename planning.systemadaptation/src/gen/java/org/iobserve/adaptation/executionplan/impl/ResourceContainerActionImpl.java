 ...
 * </p>
 * <ul>
 *   <li>{@link org.iobserve.adaptation.executionplan.impl.ResourceContainerActionImpl#getSourceResourceContainer <em>Source Resource Container</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourceContainerActionImpl extends ActionImpl implements ResourceContainerAction {
        ...
        if (sourceResourceContainer != null && ((EObject)sourceResourceContainer).eIsProxy()) {
            ...
            if (sourceResourceContainer != oldSourceResourceContainer) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionplanPackage.RESOURCE_CONTAINER_ACTION__SOURCE_RESOURCE_CONTAINER, oldSourceResourceContainer, sourceResourceContainer));
            }
        }
    ...
    public void setSourceResourceContainer(ResourceContainer newSourceResourceContainer) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ExecutionplanPackage.RESOURCE_CONTAINER_ACTION__SOURCE_RESOURCE_CONTAINER, oldSourceResourceContainer, sourceResourceContainer));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ExecutionplanPackage.RESOURCE_CONTAINER_ACTION__SOURCE_RESOURCE_CONTAINER:
