...
/**
 * This is the item provider adapter for a {@link org.iobserve.planning.systemadaptation.Action} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Action_resourceContainer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Action_resourceContainer_feature", "_UI_Action_type"),
				 systemadaptationPackage.Literals.ACTION__RESOURCE_CONTAINER,
				 true,
				 false,
				 true,
				 null,
