 ...
 *
 */
public class ClassEventMatcher<T> implements IEventMatcher<T> {
    ...
    /**
     * Create an event matcher to match events for a specific class.
     *
     * @param type
     ...
     */
    public ClassEventMatcher(final Class<T> type, final IEventMatcher<? extends Object> successor) {
        this.type = type;
