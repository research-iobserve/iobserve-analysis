...
public final class EventBasedTrace {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(EventBasedTrace.class);
    ...
    public void insertEvent(final AbstractTraceEvent event) {
        ...
        synchronized (this) {
            if (this.traceId == -1) {
                ...
                EventBasedTrace.LOG.error("Invalid traceId! Expected: " + this.traceId + " but found: " + myTraceId
    ...
    public void setTrace(final TraceMetadata traceMetaData) {
        ...
        synchronized (this) {
            ...
            if (this.traceMetaData == null) {
                ...
                EventBasedTrace.LOG.error("Duplicate Trace entry for traceId " + myTraceId);
                this.damaged = true;
            }
        }
    }
