...
import org.iobserve.analysis.clustering.filter.TBehaviorModelAggregator;
...
import teetime.stage.basic.distributor.Distributor;
	...
	public class TBehaviorModelGeneralPreprocessing extends CompositeStage {
	    ...
	    private final TBehaviorModelAggregator tBehaviorModelAggregator;
	     ...
	     *            model configuration
	     */
	    public TBehaviorModelGeneralPreprocessing(final BehaviorModelConfiguration configuration) {
	        ...
	        /*TODO setup proper terminationCondition*/
	        this.clock = new Clock(new StageHasTerminated(tBehaviorModelTableGeneration));
	        this.clock.setInitialDelayInMs(1000);
	        this.clock.setIntervalDelayInMs(1000);
	        this.tBehaviorModelAggregator = new TBehaviorModelAggregator();
	        ...
	        this.connectPorts(this.tBehaviorModelPreperation.getOutputPort(), this.tBehaviorModelAggregator.getInputPort());
	        this.connectPorts(this.clock.getOutputPort(), this.tBehaviorModelAggregator.getTimestampTriggerInputPort());
	    ...
	    public OutputPort<List<BehaviorModelTable>> getOutputPort() {
	        return this.tBehaviorModelAggregator.getOutputPort();
	    }
