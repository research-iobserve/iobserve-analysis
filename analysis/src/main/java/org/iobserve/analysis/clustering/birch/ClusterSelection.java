 ...
 * Selects a clustering out of all the 
 * clustering arriving at this stage.
 * Calculates correct cluster size
 * based on l-method.
 */
public class ClusterSelection extends AbstractConsumerStage<List<ClusteringFeature>> {
	...
	private void sendResult() {
		...
		final Optional<List<ClusteringFeature>> result = this.list.stream().filter(
