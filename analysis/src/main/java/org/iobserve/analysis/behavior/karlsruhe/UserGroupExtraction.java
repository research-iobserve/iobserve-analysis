...
import org.iobserve.analysis.behavior.karlsruhe.data.UserSessionAsCountsOfCalls;
...
public class UserGroupExtraction {
    ...
    private final UserSessionCollectionModel entryCallSequenceModel;
    private final int numberOfUserGroupsFromInputUsageModel;
    private final int varianceOfUserGroups;
    private List<UserSessionCollectionModel> entryCallSequenceModelsOfUserGroups = null;
     ...
     */
    public UserGroupExtraction(final UserSessionCollectionModel entryCallSequenceModel,
    ...
    public void extractUserGroups() {
         ...
         * sessions
         */
        final List<UserSessionCollectionModel> entryCallSequenceModelsOfXMeansClustering = clusteringProcessing
     ...
     */
    public List<UserSessionCollectionModel> getEntryCallSequenceModelsOfUserGroups() {
