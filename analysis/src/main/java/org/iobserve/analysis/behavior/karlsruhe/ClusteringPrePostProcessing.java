...
public class ClusteringPrePostProcessing {
     ...
     */
    public List<UserSessionCollectionModel> getForEachUserGroupAnEntryCallSequenceModel(
            final ClusteringResults clusteringResults, final UserSessionCollectionModel callSequenceModel) {
    ...
    public void setTheWorkloadIntensityForTheEntryCallSequenceModels(
            final List<UserSessionCollectionModel> entryCallSequenceModels, final boolean isClosedWorkload) {
