...
public class VectorQuantizationClusteringStage extends AbstractConsumerStage<Instances> {

    private static final Logger LOGGER = LoggerFactory.getLogger(VectorQuantizationClusteringStage.class);
     ...
     *            clustering used
     */
    public VectorQuantizationClusteringStage(final IVectorQuantizationClustering clustering) {
