...
/**
 * A ClusteringFeature is a cluster condensed into three principal 
 * quantities: The number of vectors in the cluster, their linear sum
 * and the sum of the squared vectors.
