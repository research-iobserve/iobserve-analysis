 ...
 *
 */
public class UsageModelToBehaviorModelStage extends AbstractConsumerStage<UsageModel> {
     ...
     * constructor.
     */
    public UsageModelToBehaviorModelStage() {
    ...
    private Map<EntryCallNode, Double> traverseBranch(final BehaviorModel behaviorModel,
        ...
        return branch.getBranchTransitions_Branch().stream()
    ...
    private EntryCallNode createEntryCallNode(final EntryLevelSystemCall entryLevelSystemCall) {
        ...
        return new EntryCallNode(signature);
    }
