...
import org.iobserve.analysis.behavior.clustering.em.IDensitityClustering;
 ...
 *
 */
public class DensityClusteringStage extends AbstractConsumerStage<Instances> {
     ...
     */
    public DensityClusteringStage(final IDensitityClustering clustering) {
