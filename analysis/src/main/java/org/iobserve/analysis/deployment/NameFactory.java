...
/**
 * Create names for allocation contexts, resource containers, assembly contexts and other elements
 * in a unified way to mitigate different naming schemes in filters.
 *
 * @author Reiner Jung
 *
 */
