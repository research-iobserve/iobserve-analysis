...
public class ResourceEnvironmentCloudBuilder {
	...
	public static ProcessingResourceSpecification createProcessingResource(final int nrOfCores,
		...
		ProcessingResourceSpecification processor = ResourceenvironmentFactory.eINSTANCE
				.createProcessingResourceSpecification();
		PCMRandomVariable pcmProcessingRate = CoreFactory.eINSTANCE.createPCMRandomVariable();
	...
	/**
	 * Create a {@link ResourceContainerCloud} with the given name, without
	 ...
	 *            resource environment model
	 * @param spec
	 *            specification of the linking resource, default values apply if
	 *            this is null
	 * @param name
	...
	public static LinkingResource createLinkingResource(final ResourceEnvironment model,
		...
		if (spec == null) {
			CommunicationLinkResourceSpecification defaultSpec = ResourceEnvironmentCloudBuilder
					.createLinkingResourceSpecification(model, DEFAULT_THROUGHPUT, DEFAULT_FAILURE_PROB,
							DEFAULT_LATENCY);
	...
	/**
	 * Creates a communication link resource specification with the given
	 * properties.
	 *
	 * @param model
	 *            resource environment model
	...
	public static CommunicationLinkResourceSpecification createLinkingResourceSpecification(
		...
		PCMRandomVariable throughputPCM = CoreFactory.eINSTANCE.createPCMRandomVariable();
		...
		PCMRandomVariable latencyPCM = CoreFactory.eINSTANCE.createPCMRandomVariable();
