...
public class AcquireActionScript extends ExecutionScript {
	...
	public void execute() throws RunNodesException {
		...
		NodeMetadata node = getOnlyElement(client.createNodesInGroup(cloudContainer.getEntityName(), 1, template));
	...
	private String getStartupScript() {
		URI nodeStartupScriptURI = this.data.getDeployablesFolderURI()
				.appendSegment(AdaptationData.NODE_STARTUP_SCRIPT_NAME).appendFileExtension("sh");
