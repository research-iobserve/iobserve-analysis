/**
 */
package org.iobserve.analysis.model.correspondence.util;
...
public class CorrespondenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CorrespondencePackage.IMPLEMENTATION_ARTIFACT_SET: {
			...
			case CorrespondencePackage.IMPLEMENTATION_ARTIFACT: {
