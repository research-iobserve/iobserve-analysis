...
public class PayloadAwareEntryCallEvent extends EntryCallEvent implements IPayloadCharacterization {
     ...
     *            requestType
     */
    public PayloadAwareEntryCallEvent(final long entryTime, final long exitTime, final String operationSignature,
            final String classSignature, final String sessionId, final String hostname, final String[] parameters,
     ...
     */
    @Deprecated
    protected PayloadAwareEntryCallEvent(final Object[] values, final Class<?>[] valueTypes) { // NOPMD
                                                                                               // (values
                                                                                               // stored
                                                                                               // directly)
